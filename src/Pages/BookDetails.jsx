...
const BookDetails = () => {
  ...
  const {bookName, author, imageLink, category, rating, longReview, totalPage, yearOfPublishing, publisher } =singleBook || {};
  return (
    <div className="lg:flex gap-4 mt-12">
      ...
      <div className=" lg:w-2/3 mt-6 lg:mt-0">
        ...
        <div>
          <h6 className="border-y-2 text-xl font-medium opacity-80 py-4 mt-6">{category}</h6>
        </div>
        <p className="mt-6">
          <span className="font-bold leading-6">Review:</span> <span className="opacity-70 leading-6">{longReview}</span>
        </p>
        <div className="border-b-2 pb-5 flex items-center mt-7">
        <p className="font-bold">Tag:</p>
          <button className="btn">youn </button>
          <button className="btn">youn </button>
        </div>
        <div className="mt-6">
